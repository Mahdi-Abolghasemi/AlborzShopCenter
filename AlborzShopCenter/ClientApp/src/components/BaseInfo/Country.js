...
export class Country extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [],
      formData: { id: 0, name: "", deleted: 0, useOrder: 1, regionCode: "" },
      searchData: { name: "", useOrder: -1, regionCode: 0 },
      showSaveModal: 0,
      result: "",
      showDeleteModal: 0,
      deleteData: { id: "", name: "" },
      ...
      offset: 0,
      currentPage: 1,
      fieldValidations: { name: true, regionCode: true },
      cardTitle: "New a country",
    };

    this.dataSource = new RestDataSource("Countries");
  }
  ...
  checkValidation = () => {
    let error = 0;
    let _fieldValidations = { name: true, regionCode: true };
      ...
      <section className="bodyApp">
        ...
        <div className="padding-table">
          <table className="table table-sm table-striped table-bordered">
            <thead>
              <tr>
                <th colSpan="4" className="table-header text-center h4 p-2">
                  Country
                </th>
              </tr>
            ...
            <tbody>
              {this.sliceData().map((p) => (
                <tr key={p.id}>
                  ...
                  <td className="col-7">{p.name}</td>
                  <td className="col-2">{p.regionCode}</td>
                  <td>
                    <button
          ...
          <Modal.Body>
            ...
            <div className="position-relative">
              <input
                ...
                placeholder="Enter Region Code"
                onChange={this.setValues}
                value={this.state.formData.regionCode}
                style={
                  this.state.fieldValidations.regionCode
                    ? {
                        borderColor: "#ced4da",
                      }
                    : { borderColor: "#dc3545" }
              ...
              <div
                className="invalid-tooltip"
                style={{
                  display: this.state.fieldValidations.regionCode
                    ? "none"
                    : "inline",
                }}
              >
        ...
        <Modal show={this.state.showDeleteModal}>
          <Modal.Header>
            <h5>Delete {this.state.deleteData.name} Country</h5>
            <button
              type="button"
              className="btn btn-danger close"
